-- =================================================================
-- INSTRUÇÕES PARA O UTILIZADOR / INSTRUCTIONS FOR USER
-- =================================================================
-- 1. Aceda ao Dashboard do Supabase (https://supabase.com/dashboard)
-- 2. Selecione o seu projeto.
-- 3. Vá ao "SQL Editor" (ícone de terminal na barra lateral esquerda).
-- 4. Clique em "New Query".
-- 5. Copie e cole TODO o conteúdo abaixo (excluindo estas instruções se quiser).
...
CREATE TABLE IF NOT EXISTS public.via_verde_toll_records (
    ...
    type TEXT DEFAULT 'toll', -- 'toll' or 'parking'
    created_at TIMESTAMPTZ DEFAULT NOW(),
    created_by UUID REFERENCES auth.users(id)
);

-- 1.1 Add column if table already exists (for updates)
DO $$ 
BEGIN 
