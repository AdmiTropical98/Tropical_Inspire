...
{
    sf_load_env_file_if_present(__DIR__ . '/.env');
...
function sf_render_html_page(string $title, string $message, string $accentColor): void
{
    ...
    echo 'p{margin:0;color:#dbe7ff;line-height:1.6;}';
    echo '.accent{color:' . htmlspecialchars($accentColor, ENT_QUOTES, 'UTF-8') . ';font-weight:700;}';
    echo '</style>';
    echo '</head>';
    echo '<body>';
    echo '<section class="card">';
    echo '<h1 class="accent">' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '</h1>';
