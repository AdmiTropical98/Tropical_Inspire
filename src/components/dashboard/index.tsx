...
export default function Dashboard({
    ...
    return (
        <div className="h-full w-full overflow-y-auto custom-scrollbar p-6 space-y-8 bg-slate-950">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {isEditMode ? (
                        ...
                        >
                            <LayoutIcon className="w-4 h-4" /> Personalizar
                        </button>
                    )}
            ...
            <DraggableGrid
                key={gridKey} // FORCE LAYOUT RESET ON MOUNT
                ...
                defaultLayouts={{
                    lg: [
                        ...
                        { i: 'chart_fleet_status', x: 3, y: 4, w: 3, h: 8 },
                        { i: 'chart_revenue', x: 6, y: 4, w: 6, h: 8 },
                        { i: 'table_activity', x: 0, y: 12, w: 12, h: 8 }
                    ],
                    md: [
                        ...
                        { i: 'widget_quick_actions', x: 0, y: 8, w: 5, h: 8 },
                        { i: 'chart_fleet_status', x: 5, y: 8, w: 5, h: 8 },
                        { i: 'chart_revenue', x: 0, y: 16, w: 10, h: 8 },
                        { i: 'table_activity', x: 0, y: 24, w: 10, h: 8 }
                    ],
                    sm: [
                        ...
                        { i: 'chart_fleet_status', x: 0, y: 22, w: 6, h: 6 },
                        { i: 'chart_revenue', x: 0, y: 28, w: 6, h: 6 },
                        { i: 'table_activity', x: 0, y: 34, w: 6, h: 8 }
                    ]
                }}
            >
