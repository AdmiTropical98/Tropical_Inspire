    ...
    return (
        <div className="h-full overflow-y-auto custom-scrollbar p-6 space-y-8 bg-slate-950">
            ...
            <div className="space-y-6">
                ...
                {/* 2. Middle Section: Actions & Charts */}
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">

                    {/* Quick Actions (1 col) */}
                    <div className="lg:col-span-1 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                        <QuickActions
                    ...
                    {hasAccess(userRole, 'viaturas') ? (
                        ...
                        // Spacer if no access, or maybe expand Revenue Chart? 
                        // For simplicity, we just won't render or leave empty div.
                        /* Optional logical check to expand revenue chart if fleet hidden? 
                           Let's stick to simple grid for now. */
                        <div className="hidden lg:block lg:col-span-1"></div>
                    )}

                    {/* Revenue/Services Chart (2 cols) */}
                    <div className="lg:col-span-2 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400">
                        <RevenueChart services={servicos} />
                    </div>
                </div>

                {/* 3. Bottom Section: Activity Feed */}
