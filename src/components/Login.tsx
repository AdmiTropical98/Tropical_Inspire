...
export default function Login() {
    ...
    return (
        <div className="min-h-[100dvh] w-full bg-[#0f172a] flex flex-col items-center p-4 relative transition-all duration-500 login-scrollbar overflow-y-auto py-12">
            {/* Background Effects */}
            ...
            <div className="w-full max-w-xl relative z-10 flex flex-col items-center gap-0 mt-4 sm:mt-8 mb-8">
                <img
