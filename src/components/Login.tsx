...
export default function Login() {
    ...
    return (
        <div className="min-h-[100dvh] w-full bg-[#0f172a] flex flex-col items-center justify-center p-4 relative transition-all duration-500 login-scrollbar overflow-y-auto py-12 sm:py-0">
            {/* Background Effects */}
            ...
            <div className="w-full max-w-xl relative z-10 flex flex-col items-center gap-0 mt-12 transform translate-y-6">
                <img
                    ...
                    alt="Algar Frota"
                    className="h-48 w-auto object-contain drop-shadow-2xl relative z-20"
                />
