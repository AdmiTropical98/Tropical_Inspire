...
import { UserCog, Plus, Trash2, AlertCircle, Shield, Share2, MessageSquare, Search, TrendingUp, Users, UserX, Clock, Grid3x3, List, Upload, X } from 'lucide-react';
    ...
    const handlePhotoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                setNewSupervisor({ ...newSupervisor, foto: base64 });
            };
                        ...
                        <div className="flex justify-center mb-4">
                            <div className="relative">
                                ...
                                {photoPreview && (
                                    <button
                                        type="button"
                                        onClick={() => { setPhotoPreview(''); setNewSupervisor({ ...newSupervisor, foto: '' }); }}
