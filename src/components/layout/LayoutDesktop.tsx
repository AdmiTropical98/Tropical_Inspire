...
export default function LayoutDesktop({ isFullScreenPage, navbar, children }: LayoutDesktopProps) {
  return (
    <div style={{ width: '100%', maxWidth: 'none', margin: 0 }} className={`layout-desktop app-root w-full flex flex-col overflow-x-hidden bg-transparent text-slate-900 font-sans selection:bg-amber-500/20 ${isFullScreenPage ? 'h-[100dvh]' : 'min-h-[100dvh]'}`}>
      {navbar}
