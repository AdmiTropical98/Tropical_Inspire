        ...
        <div className="flex flex-col w-full h-full bg-[#0f172a] relative overflow-y-auto md:overflow-hidden custom-scrollbar">
            ...
            <div className="flex-1 overflow-hidden relative">
                ...
                `}>
                        ...
                        {viewMode === 'table' && (
                            <div className="flex-1 flex items-center justify-center text-slate-500 bg-[#1e293b]/30 h-full">
                                <div className="text-center">
                                    <p className="text-lg font-bold text-white mb-2">Vista de Tabela em Manutenção</p>
                                    <p className="text-sm">Estamos a resolver um erro técnico. Por favor use a vista de Cartões.</p>
                                </div>
                            </div>
                        )}
