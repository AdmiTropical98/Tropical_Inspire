    ...
    return (
        <div className="space-y-8 animate-fade-in pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {/* 1. Drivers Section */}
                <div className="bg-slate-100 p-6 rounded-2xl border border-slate-200/50 flex flex-col h-[500px]">
                    ...
                    {/* Table */}
                    <div className="flex-1 overflow-auto custom-scrollbar rounded-lg border border-slate-200/50">
                        <table className="w-full text-sm text-left text-slate-300">
                            <thead className="bg-white/90/80 sticky top-0 backdrop-blur-sm text-xs uppercase font-medium text-slate-400">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-700/50">
                                {topDrivers.map((driver) => (
                                    <tr key={driver.id} className="hover:bg-slate-700/30 transition-colors">
                                        <td className="px-4 py-2.5 text-slate-900 font-medium">{driver.nome}</td>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {/* 3. Fuel Analysis */}
                <div className="bg-slate-100 p-6 rounded-2xl border border-slate-200/50">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h3 className="text-lg font-bold text-[#1f2957] flex items-center gap-2">
                    ...
                    <div className="overflow-hidden rounded-lg border border-slate-200/50">
                        <table className="w-full text-sm text-left text-slate-300">
                            <thead className="bg-white/90/80 text-xs uppercase font-medium text-slate-400">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-700/50">
                                {fuelStats.length > 0 ? fuelStats.map((item, idx) => (
                                    <tr key={idx} className="hover:bg-slate-700/30 transition-colors">
                                        <td className="px-4 py-3 text-slate-900 text-xs font-medium">{item.vehicleName}</td>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-slate-100 p-6 rounded-2xl border border-slate-200/50">
                        ...
                        <div className="overflow-hidden rounded-lg border border-slate-200/50 max-h-[200px] overflow-y-auto custom-scrollbar">
                            <table className="w-full text-sm text-left text-slate-300">
                                <thead className="bg-white/90/80 sticky top-0 backdrop-blur-sm text-xs uppercase font-medium text-slate-400">
                                    <tr>
                                ...
                                <tbody className="divide-y divide-slate-700/50">
                                    {financialStats.map((item) => (
                                        <tr key={item.id} className="hover:bg-slate-700/30">
                                            <td className="px-4 py-2 text-slate-900 text-xs">
