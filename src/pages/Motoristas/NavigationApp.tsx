...
export default function NavigationApp({
                    ...
                    if (match && match.latitude && match.longitude) {
                        ...
                        try {
                            ...
                            if (geoData && geoData[0]) {
                                ...
                                alert(`N├úo conseguimos encontrar coordenadas para "${destinationName}" nem pesquisando no mapa global. Por favor, reportar ao suporte.`);
                                setLoading(false);
                                return;
                            }
                        } catch (err) {
    ...
    const startNavigation = async () => {
        ...
        if ('geolocation' in navigator) {
            ...
            alert('Geolocaliza├º├úo n├úo suportada neste dispositivo.');
        }
    };
            ...
            >
                ...
                {isNavigating && !hasGpsLock && (
                    <div className="absolute inset-0 bg-slate-950 z-[10002] flex flex-col items-center justify-center p-6 text-center animate-in fade-in">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">A obter localiza├º├úo...</h3>
                        <p className="text-slate-400 max-w-xs mx-auto mb-8">Estamos a ligar aos sat├⌐lites para detetar a sua posi├º├úo em Quarteira.</p>
            ...
            {showSelection && (
                <div className="absolute inset-0 z-[10001] bg-slate-950 flex flex-col p-6 animate-in slide-in-from-bottom duration-300">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar space-y-2">
                        <div className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 px-2">Geofences Dispon├¡veis ({filteredGeofences.length})</div>
                        ...
                        {filteredGeofences.length === 0 && (
                            <div className="text-center py-10 text-slate-500">
                                {error ? (
                                    ...
                                    <p>Local n├úo encontrado na lista.</p>
                                )}
