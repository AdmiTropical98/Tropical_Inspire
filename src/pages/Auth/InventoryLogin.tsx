...
export default function InventoryLogin() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,0.05)_0%,rgba(0,0,0,0.08)_42%,rgba(2,10,20,0.36)_100%)]" />
      ...
      <div className="relative z-10 min-h-[100dvh] w-full">
        <main className="relative flex min-h-[100dvh] items-center justify-center px-5 py-10 sm:px-8 lg:absolute lg:inset-y-0 lg:right-0 lg:w-[46%] lg:justify-center lg:px-0">
          <div className="w-full max-w-[430px] rounded-[34px] border border-[#d6e5ef91] bg-[linear-gradient(180deg,rgba(10,26,40,0.78)_0%,rgba(6,20,34,0.66)_100%)] px-7 py-8 shadow-[0_20px_48px_rgba(0,0,0,0.45)] backdrop-blur-[8px] sm:px-9 sm:py-9">
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#9fd9c66e] bg-emerald-400/10 px-4 py-1.5">
              <Lock className="h-3.5 w-3.5 text-emerald-300" />
              <span className="text-[12px] font-black uppercase tracking-[0.13em] text-emerald-300">Acesso Direto</span>
            </div>

            <h2 className="text-[56px] font-black leading-[0.9] tracking-[-0.03em] text-white">
              Bem-<span className="text-emerald-400">vindo</span>
            </h2>
            <p className="mt-2 text-[48px] leading-[0.95] tracking-[-0.03em] text-white">ao Inventário</p>
            <p className="mt-3 text-[20px] text-slate-300">Inicie sessão para aceder ao seu inventário.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="h-[56px] w-full appearance-none rounded-[12px] border border-[#d6e5ef88] bg-[#071c2aab] pl-11 pr-10 text-[16px] font-semibold text-white outline-none transition focus:border-emerald-300 focus:ring-2 focus:ring-emerald-300/30"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder={role === 'gestor' ? 'utilizador@empresa.pt ou 9XXXXXXXX' : 'utilizador@empresa.pt'}
                    className="h-[56px] w-full rounded-[12px] border border-[#d6e5ef88] bg-[#071c2aab] pl-11 pr-4 text-[17px] text-white outline-none transition placeholder:text-slate-400 focus:border-emerald-300 focus:ring-2 focus:ring-emerald-300/30"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder={role === 'gestor' ? 'PIN ou palavra-passe' : '••••••••'}
                    className="h-[56px] w-full rounded-[12px] border border-[#d6e5ef88] bg-[#071c2aab] pl-11 pr-12 text-[17px] text-white outline-none transition placeholder:text-slate-400 focus:border-emerald-300 focus:ring-2 focus:ring-emerald-300/30"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between text-[13px]">
                ...
                <button type="button" className="font-semibold text-emerald-400 transition hover:text-emerald-300">Esqueci a palavra-passe?</button>
              </div>
              ...
              <button
                ...
                className="group flex h-[56px] w-full items-center justify-center gap-2 rounded-[12px] bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 text-[16px] font-black uppercase tracking-[0.12em] text-white shadow-[0_14px_30px_rgba(16,185,129,0.35)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(16,185,129,0.45)] disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <p className="mt-5 text-center text-[15px] text-slate-300">
              Voltar para{' '}
              <button onClick={() => navigate('/', { replace: true })} className="font-bold text-emerald-400 hover:text-emerald-300">
                seleção de sistemas
              </button>
            </p>
          </div>
