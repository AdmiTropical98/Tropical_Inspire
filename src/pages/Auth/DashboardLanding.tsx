...
export default function DashboardLanding() {
  ...
  const modules = [
    ...
    },
    {
      key: 'fornecedores',
      title: 'Fornecedores',
      description: 'Gestão empresarial de fornecedores, contratos, pagamentos e requisições. Módulo enterprise independente.',
      image: assetPath('logo-new.png'),
      icon: Grid3X3,
      features: [
      ...
      buttonClass: 'from-[#1a237e] to-[#283593] shadow-[0_0_28px_rgba(44,80,255,0.45)]',
      iconClass: 'bg-[#1a237e] shadow-[0_0_22px_rgba(44,80,255,0.45)]',
      accent: '#283593',
      borderColor: 'rgba(44,80,255,0.65)',
      cardShadow: '0 0 40px rgba(44,80,255,0.28), 0 15px 40px rgba(0,0,0,0.32)',
      imagePosition: 'center 60%',
      route: '/fornecedores/login',
    },
    {
      key: 'inventario',
      title: 'Inventário',
