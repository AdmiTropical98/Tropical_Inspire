        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {[
                    ...
                    <div key={i} className="bg-white/90 border border-slate-200/50 p-5 rounded-3xl group">
            ...
            {/* Search & Filter */}
            <div className="bg-white/90 backdrop-blur-xl border border-slate-200/60 p-4 rounded-2xl flex flex-col md:flex-row gap-4">
                <div className="relative flex-1 group">
                    ...
                    <input
                        ...
                        className="w-full bg-white/90 border border-slate-200 rounded-xl pl-12 pr-4 py-3 text-slate-200 outline-none focus:ring-2 focus:ring-indigo-600/40 transition-all"
                        value={searchTerm}
                    ...
                    {['all', 'available', 'assigned', 'maintenance', 'retired'].map(status => (
                        <button
                            ...
                            className={`px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all border whitespace-nowrap ${statusFilter === status
                                ...
                                : 'bg-slate-100 border-slate-200 text-slate-500 hover:text-slate-300'
                                }`}
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {filteredAssets.map(asset => {
                    ...
                    return (
                        <div key={asset.id} className="group bg-slate-50/60 hover:bg-white/90 border border-slate-200/50 hover:border-indigo-600/30 rounded-3xl p-6 transition-all duration-500 relative flex flex-col">
                            ...
                            <h3 className="text-lg font-black text-slate-900 group-hover:text-indigo-400 transition-colors mb-2 line-clamp-1">
                                {asset.name}
                            </h3>

                            <div className="space-y-3 mb-6">
                                <div className="flex items-center gap-2 text-slate-500 px-2 py-1.5 bg-slate-50 rounded-lg border border-slate-200/50">
                            ...
                            <div className="mt-auto pt-4 border-t border-slate-200/50">
                                ...
                                <div className="flex items-center gap-3 bg-white/40 p-2 rounded-2xl hover:bg-white/60 transition-colors cursor-pointer border border-slate-200/30">
                            ...
                            <div className="mt-4 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
                                <button className="flex-1 bg-slate-100 hover:bg-slate-700 text-slate-300 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest border border-slate-200 transition-all flex items-center justify-center gap-2">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
                    <div className="w-full max-w-2xl bg-white/90 border border-slate-200 rounded-3xl shadow-2xl overflow-hidden">
                        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-200">
                            <h3 className="text-xl font-black text-slate-900">Novo Equipamento</h3>
                            <button
                                type="button"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-1.5 md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-200 outline-none focus:ring-2 focus:ring-indigo-500/40"
                                    />
                                </div>
                                ...
                                <div className="space-y-1.5 md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 h-24 resize-none bg-white border border-slate-200 rounded-xl text-slate-200 outline-none focus:ring-2 focus:ring-indigo-500/40"
                                    />
                                </div>
                            </div>
