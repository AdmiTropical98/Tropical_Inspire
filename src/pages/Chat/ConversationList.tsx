...
export default function ConversationList({
    ...
    return (
        <div className="flex flex-col h-full gap-3">
            {/* Search Bar */}
            <div className="shrink-0 bg-[#1e293b]/50 backdrop-blur-xl border border-slate-200/50 rounded-2xl p-4 flex flex-col gap-3">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-white/90 border border-slate-200 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-900 focus:border-blue-500/50 outline-none transition-colors"
                    />
                </div>
                ...
                <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                    ...
                    <span className="bg-slate-100 px-3 py-1 rounded-full text-xs font-bold text-slate-400 border border-slate-200 whitespace-nowrap cursor-pointer hover:bg-slate-700 transition-colors">
                        Motoristas
                    </span>
                    <span className="bg-slate-100 px-3 py-1 rounded-full text-xs font-bold text-slate-400 border border-slate-200 whitespace-nowrap cursor-pointer hover:bg-slate-700 transition-colors">
                        Equipa
            ...
            {/* Conversations List */}
            <div className="flex-1 min-h-0 bg-[#1e293b]/50 backdrop-blur-xl border border-slate-200/50 rounded-2xl p-3 overflow-y-auto custom-scrollbar space-y-2">
                {loadingContacts ? (
                        ...
                        return (
                            <button
                                ...
                                ${isSelected
                                    ...
                                    : 'bg-slate-50 border-transparent hover:bg-slate-100 hover:border-slate-200/30'
                                }`}
                            >
