...
export default function ColaboradoresPage() {
  ...
  return (
    <div className="space-y-6 pb-24">
      ...
      <div className="flex flex-wrap gap-2 rounded-2xl border border-slate-700/50 bg-slate-900/50 p-1.5">
        <button
          type="button"
          onClick={() => {
            if (isScannerOpen) {
          ...
          className={`inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold transition-colors ${
            activeView === 'colaboradores' ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800'
          }`}
        >
        ...
        <button
          ...
          className={`inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold transition-colors ${
            activeView === 'leitor' ? 'bg-emerald-600 text-white' : 'text-slate-300 hover:bg-slate-800'
          }`}
        >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.1fr_0.9fr] gap-6">
          <div className="bg-slate-900/60 border border-slate-700/50 rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h2 className="text-white font-black text-lg tracking-tight">Leitor do Motorista</h2>
                <p className="text-sm text-slate-400">Use esta aba apenas para validar entradas por QR/NFC.</p>
              </div>
            </div>
          ...
          <div className="bg-slate-900/60 border border-slate-700/50 rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-white font-black text-lg tracking-tight">Pré-visualização da leitura</h3>
            </div>

            {checkinPreview ? (
              <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-4">
                <p className="text-[11px] uppercase tracking-wider text-emerald-300 font-bold">Colaborador lido</p>
                <p className="text-white font-black text-xl mt-2">{checkinPreview.colaborador.nome}</p>
              ...
              <div className="rounded-2xl border border-dashed border-slate-700 bg-slate-950/60 p-6 text-center">
                <p className="text-slate-300 font-bold">Nenhum QR lido ainda</p>
